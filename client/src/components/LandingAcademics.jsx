...
const LandingAcademics = () => {
  return (
    <section className="w-full flex flex-col lg:flex-row pt-16 md:pt-20 lg:pt-24">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white text-black p-6 sm:p-8 md:p-10 lg:p-12 min-h-[300px] sm:min-h-[400px] lg:min-h-[500px]">
      ...
      <div className="w-full lg:w-1/2 min-h-[300px] sm:min-h-[400px] md:min-h-[500px] lg:max-h-[500px] p-4 sm:pt-4 sm:p-6 lg:p-0">
        <img
          src="/landingAcademics.jpg"
          alt="School Building"
