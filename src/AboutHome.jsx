...
function AboutHome() {
    return (
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 bg-white place-content-center px-8 py-8 shadow-xl">
            <div className="lg:col-span-2 col-span-1 p-4 text-black text-center">
                <h2 className="font-sans text-2xl font-bold text-black uppercase">About Kiguruyembe Secondari</h2>
                <p>
            ...
            <div className="p-4 rounded-xl border-2 border-black bg-emerald-700/50 text-black">
                <h2 className="font-sans text-2xl font-bold text-black uppercase">Our Mission</h2>
                <p>
            ...
            <div className="p-4 rounded-xl border-2 border-black bg-emerald-700/50 text-black">
                <h2 className="font-sans text-2xl font-bold text-black uppercase">Our Vision</h2>
                <p>
