    ...
    return (
        <section>
            <section className="flex flex-col pt-20 px-10">
                ...
                <p className="text-lg py-2 font-semibold border-b-2 border-gray-500">
            ...
            <section className="w-full h-[30vh] md:h-[60vh] lg:h-[80vh] relative text-white flex items-center justify-center px-10 py-5">
                <img 
